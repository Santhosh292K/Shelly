...
useEffect(() => {
  ...
  return (
   <div className="flex flex-col items-center justify-center relative">
      ...
      {showDialog && (
  <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 z-30 transition-all duration-500 ease-out">



          {/* Speech bubble */}
          <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl px-4 py-2 shadow-2xl border border-blue-200 w-[300px] mx-auto relative animate-bounce-in">
            ...
            <div className="text-center">
              <div className="flex items-center justify-center mb-0">
                <div className={`w-2 h-2 rounded-full mr-1 shadow-lg ${
              ...
              <p className="text-xs text-gray-700 leading-snug font-semibold mb-1">
                {displayMessage}
              </p>
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute w-3 h-3 bg-yellow-400 rounded-full opacity-60 animate-float-3" style={{top: '130%', left: '10%'}}></div>
        <div className="absolute w-2 h-2 bg-purple-400 rounded-full opacity-60 animate-float-4" style={{top: '120%', right: '10%'}}></div>
      </div>
